...
VALUES 
  ...
  ('e8105244-b334-4ccd-a943-9bf7382463f8', 'UPDATE', 'security_profile_permissions', null, '45.160.193.179'::inet, 'Mozilla/5.0', '{"permission_change": true}', '{"granted": false}', '{"granted": true}');

-- Adicionar permissões ao perfil Admin
INSERT INTO security_profile_permissions (profile_id, permission_id, granted, granted_by, granted_at)
SELECT 
