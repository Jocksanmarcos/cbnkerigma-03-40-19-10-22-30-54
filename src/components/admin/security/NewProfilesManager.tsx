...
import { Plus, Edit2, Trash2, Shield, Users, Settings, Eye, Crown, Globe, BookOpen, DollarSign, User } from 'lucide-react';
...
const ICON_OPTIONS = [
  ...
  { value: 'User', icon: User, label: 'Usuário' },
  { value: 'Settings', icon: Settings, label: 'Configurações' },
  { value: 'Eye', icon: Eye, label: 'Visualização' }
];

const COLOR_OPTIONS = [
  '#ef4444', '#f59e0b', '#3b82f6', '#10b981', '#8b5cf6', '#ec4899', '#6b7280', '#94a3b8'
];

export const NewProfilesManager: React.FC = () => {
  const { profiles, loading, createProfile, updateProfile, deleteProfile } = useNewRBAC();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-foreground">Gestão de Perfis RBAC</h2>
          <p className="text-muted-foreground">
            Gerencie os perfis de acesso do sistema com controle granular
          </p>
        </div>
