...
import { NewProfilesManager } from './NewProfilesManager';
import { NewPermissionMatrix } from './NewPermissionMatrix';
import { NewPermissionsSummary } from './NewPermissionsSummary';
...
export const NewRBACManager: React.FC = () => {
  const { profiles, loading } = useNewRBAC();
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">Sistema RBAC Profissional</h1>
      ...
      {activeView === 'matrix' && (
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 min-h-[600px]">
          ...
          <div className="xl:col-span-3">
            <NewPermissionMatrix selectedProfileId={selectedProfileId} />
          </div>
        </div>
      )}
    </div>
