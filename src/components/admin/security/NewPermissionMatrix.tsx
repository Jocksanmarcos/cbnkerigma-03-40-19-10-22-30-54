...
import { Shield, Lock, DollarSign, BookOpen, Users, Home, Calendar, MessageSquare, Settings, BarChart3 } from 'lucide-react';
...
export const NewPermissionMatrix: React.FC<PermissionMatrixProps> = ({ selectedProfileId }) => {
  const { 
    profiles, 
    permissions, 
